...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    features: [
      ...
      'Alerta de planos de ação vencidos por e-mail, no botão',
      'Sem limite de tempo ou bloqueio por expiração',
    ],
    limitations: [
      'Um único administrador (demais perfis sem restrição)',
      'Alerta de planos vencidos só no botão — sem agendamento automático',
  ...
  },
  {
    ...
    features: [
      ...
      'Consulta e exportação da trilha de auditoria, com o antes e o depois de cada alteração (A.8.15)',
      'Recriação de registros excluídos a partir da própria trilha',
      'Alerta automático de planos vencidos — diário, semanal ou mensal',
      'Aviso de vencimento da licença 30, 15, 7 e 1 dia antes',
